...
const Location = () => {
  ...
  const nameOfLocation: string = data ? data.location.name : "?";
    ...
    <Template isDay={id}>
      ...
      >
        <View style={styles.mainView}>
          <Title title={decodeURIComponent(nameOfLocation)} isDay={id} />
          ...
          <Subtitle title={`Today's weather in ${nameOfLocation}`} isDay={id} />
